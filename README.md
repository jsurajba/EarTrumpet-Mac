...
<p align="center">
  ...
  <a href="https://github.com/jsurajba/EarTrumpet-Mac/releases"><img src="https://img.shields.io/badge/release-v2.3.0-brightgreen.svg" alt="Release v2.3.0"></a>
</p>
...
<p align="center">
  ...
  <a href="#building--launching">Building</a> •
...
1. **Download Latest Release**: Download [`EarTrumpet.zip`](build/EarTrumpet.zip) from the [Releases Page](https://github.com/jsurajba/EarTrumpet-Mac/releases/tag/v2.3.0).
2. **Unzip & Launch**: Uncompress `EarTrumpet.zip` and double-click `EarTrumpet.app` (or run `./run.sh` in terminal).
3. **Menu Bar Access**: Look for the trumpet icon near your Wi-Fi and Clock in the top menu bar, or press **Option + Shift + V**.

---

## Overview

**EarTrumpet for macOS** brings the volume control experience of the popular Windows utility [EarTrumpet](https://github.com/File-New-Project/EarTrumpet) to Mac. Built natively in **Swift 6** and **SwiftUI**, it provides a Menu Bar accessory app that allows you to control hardware output volume, switch playback devices instantly, scroll over your menu bar to adjust sound, and manage supported media applications.

---

## Features

- **Native Menu Bar Accessory**: Fits seamlessly into macOS with a frosted glass (`.ultraThinMaterial`) flyout UI.
...
- **Media Application Volume Control**: Adjust playback volume for supported media players (Spotify, Apple Music, QuickTime Player, VLC, IINA, TV, Podcasts, and System Alert Sounds).
...
- **Global Hotkey**: Press **Option + Shift + V** from anywhere on your Mac to toggle the volume flyout.
